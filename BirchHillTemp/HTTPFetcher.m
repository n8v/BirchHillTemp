...
//    aReceiver - the receiver
//    receiverAction - the selector on the receiver
//    tag - string to identify connection so that multiple requests can use single receiverAction
//
// returns the initialized object
//
- (id)initWithURLString:(NSString *)aURLString
                    ...
                    tag:(NSString *)myTag;
{
	...
	NSURL *url = [NSURL URLWithString:aURLString];
	NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
	return [self initWithURLRequest:request receiver:aReceiver action:receiverAction tag:myTag];
}
...
- (void)connection:(NSURLConnection *)aConnection didReceiveAuthenticationChallenge:(NSURLAuthenticationChallenge *)aChallenge
{
    if ([aChallenge previousFailureCount] <= 1)
	{
		...
		if (showAuthentication)
		{
			...
			UILabel *usernameLabel = [[UILabel alloc] initWithFrame:CGRectMake(10,38,90,30)];
			...
			usernameField = [[UITextField alloc] initWithFrame:CGRectMake(104,38,168,30)];
			...
			UILabel *passwordLabel = [[UILabel alloc] initWithFrame:CGRectMake(10,74,90,30)];
			...
			passwordField = [[UITextField alloc] initWithFrame:CGRectMake(104,74,168,30)];
